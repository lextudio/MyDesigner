...
public class DesignInstanceExtension : MarkupExtension
{
    ...
    ///     Use <see cref="IsDesignTimeCreatable" /> to specify whether an instance of your type or a designer-generated
    ///     substitute type is created.
    /// </summary>
    public Type Type { get; set; }

    /// <summary>
    ///     Gets or sets if the design instance is created from your type (true) or of a designer-generated substitute type
    ///     (false).
    /// </summary>
